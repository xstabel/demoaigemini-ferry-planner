...
// Fix: Add declarations for Google Maps API objects to resolve TypeScript errors.
...
2. **Specialized Knowledge: Ibermar Ferry Routes**
   ...
   * Valencia, Spain – Ibiza, Spain
   * Denia, Spain – Formentera, Spain
   * Algeciras, Spain – Ceuta, Spain (autonomous city)
   * Málaga, Spain – Melilla, Spain (autonomous city)
   * Motril, Spain – Melilla, Spain (autonomous city)
   * Almería, Spain – Melilla, Spain (autonomous city)
   * Algeciras, Spain – Tanger Med, Morocco
   * Almería, Spain – Nador, Morocco
   * Sète, France – Nador, Morocco
   * Valencia, Spain – Argel (Algiers), Algeria
   * Valencia, Spain – Orán (Oran), Algeria
   * Valencia, Spain – Mostaganem, Algeria
   * Barcelona, Spain – Argel (Algiers), Algeria
